...
@section('content')
    ...
    @include('frontend.home.sections.category-products-slider')

    @include('frontend.home.sections.large-banner')

    @include('frontend.home.sections.products-slider-with-control')

    @include('frontend.home.sections.services')

    @include('frontend.home.sections.blogs-slider')
