            ...
            <div class="col-xl-12">
                <div class="relative_contect d-flex">
                    ...
                    <ul class="wsus_menu_cat_item show_home toggle_menu">
                            ...
                            <li>
                                ...
                                <ul class="wsus_menu_cat_droapdown">
                                    @foreach($category->subCategories as $subCategory)
                                        <li>
                                            <a href="#">{{$subCategory->name}} <i class="fas fa-angle-right"></i></a>
                        ...
                        @endforeach
                        {{--                        <li>--}}
                        {{--                            <a class="wsus__droap_arrow" href="#"><i class="fal fa-tshirt"></i> Fashion </a>--}}
                        {{--                            <ul class="wsus_menu_cat_droapdown">--}}
                        {{--                                <li>--}}
                        {{--                                    <a href="#">New Arrivals <i class="fas fa-angle-right"></i></a>--}}
                        {{--                                    <ul class="wsus__sub_category">--}}
